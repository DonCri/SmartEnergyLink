...
function CC_GetQRCodeSVG(int $InstanceID, int $WebFrontVisualizationID)
{
  return '';
}
...
function ENO_SwitchMode(int $InstanceID, bool $DeviceOn)
{
  return true;
}
...
function HM_GetKnownDevices(int $InstanceID)
{
  return array();
}
function HM_LoadDevices(int $InstanceID, int $Protocol)
{
  return true;
}
...
function IPS_GetActiveConnections()
{
  return 0;
}
...
function IPS_IsOptionChangePending()
{
  return true;
}
...
function IPS_SetEventConditionVariableRule(int $EventID, int $ConditionID, int $RuleID, int $VariableID, int $Comparison, $Value)
{
  return true;
}
...
function IPS_SetOption(string $Option, $Value)
{
  return true;
}
...
function KNX_DoWrite(int $InstanceID, $Value)
{
  return true;
}
...
function NC_AddDevice(int $InstanceID, string $Token, string $Provider, string $DeviceID, string $Name, int $WebFrontVisualizationID)
{
  return '';
}
...
function NC_PushNotification(int $InstanceID, int $WebFrontVisualizationID, string $Title, string $Body, string $Sound)
{
  return true;
}
function NC_PushNotificationEx(int $InstanceID, int $WebFrontVisualizationID, string $Title, string $Body, string $Sound, int $CategoryID, int $TargetID)
{
  return true;
}
...
function NC_RemoveDeviceConfigurator(int $InstanceID, int $DeviceID, int $WebFrontVisualizationID)
{
  return true;
}
function NC_SetDeviceConfigurator(int $InstanceID, int $DeviceID, int $WebFrontVisualizationID, bool $Enabled)
{
  return true;
}
...
function OC_PushMessage(int $InstanceID, string $ClientID, string $Data)
{
  return true;
}
function OW_GetKnownDevices(int $InstanceID)
{
  return array();
}
...
function OZW_WriteDataPoint(int $InstanceID, $Value)
{
  return true;
}
function OZW_WriteDataPointEx(int $InstanceID, string $DataPoint, $Value)
{
  return true;
}
...
function RequestActionEx(int $VariableID, $Value, string $Sender)
{
  return true;
}
...
function SSCK_UpdateFormUseSSL(int $InstanceID, bool $UseSSL)
{
  return true;
}
...
function UC_DeleteCrashReports(int $InstanceID)
{
  return true;
}
...
function UC_GetCrashReportCount(int $InstanceID)
{
  return 0;
}
...
function UC_RequestLicenseData(int $InstanceID)
{
  return true;
}
...
function UC_SendCrashReports(int $InstanceID, string $FeedbackMail, string $Message)
{
  return true;
}
...
function WFC_Execute(int $InstanceID, int $ActionID, int $TargetID, $Value)
{
  return '';
}
...
function ZW_UICloseDialogs(int $InstanceID)
{
  return true;
}
...
class IPSModule
{
  ...
  protected function RegisterPropertyBoolean(string $Name, bool $DefaultValue)
  {
    return true;
  }
  protected function RegisterPropertyInteger(string $Name, int $DefaultValue)
  {
    return true;
  }
  protected function RegisterPropertyFloat(string $Name, float $DefaultValue)
  {
    return true;
  }
  protected function RegisterPropertyString(string $Name, string $DefaultValue)
  {
    return true;
  }
  protected function RegisterAttributeBoolean(string $Name, bool $DefaultValue)
  {
    return true;
  }
  protected function RegisterAttributeInteger(string $Name, int $DefaultValue)
  {
    return true;
  }
  protected function RegisterAttributeFloat(string $Name, float $DefaultValue)
  {
    return true;
  }
  protected function RegisterAttributeString(string $Name, string $DefaultValue)
  {
    return true;
  }
  ...
  protected function GetTimerInterval(string $Name)
  {
    return 0;
  }
  protected function RegisterScript(string $Ident, string $Name, string $Content = '', int $Position = 0)
  {
    return 0;
  }
  protected function RegisterVariableBoolean(string $Ident, string $Name, string $Profile = '', int $Position = 0)
  {
    return 0;
  }
  protected function RegisterVariableInteger(string $Ident, string $Name, string $Profile = '', int $Position = 0)
  {
    return 0;
  }
  protected function RegisterVariableFloat(string $Ident, string $Name, string $Profile = '', int $Position = 0)
  {
    return 0;
  }
  protected function RegisterVariableString(string $Ident, string $Name, string $Profile = '', int $Position = 0)
  {
    return 0;
  }
  ...
  protected function MaintainVariable(string $Ident, string $Name, int $Type, string $Profile, int $Position, bool $Keep)
  {
    return true;
  }
  protected function EnableAction(string $Ident)
  {
    return true;
  }
  protected function DisableAction(string $Ident)
  {
    return true;
  }
  protected function MaintainAction(string $Ident, bool $Keep)
  {
    return true;
  }
  ...
  protected function ReadPropertyBoolean(string $Name)
  {
    return true;
  }
  protected function ReadPropertyInteger(string $Name)
  {
    return 0;
  }
  protected function ReadPropertyFloat(string $Name)
  {
    return 0.0;
  }
  protected function ReadPropertyString(string $Name)
  {
    return '';
  }
  protected function ReadAttributeBoolean(string $Name)
  {
    return true;
  }
  protected function ReadAttributeInteger(string $Name)
  {
    return 0;
  }
  protected function ReadAttributeFloat(string $Name)
  {
    return 0.0;
  }
  protected function ReadAttributeString(string $Name)
  {
    return '';
  }
  protected function WriteAttributeBoolean(string $Name, bool $Value)
  {
    return true;
  }
  protected function WriteAttributeInteger(string $Name, int $Value)
  {
    return true;
  }
  protected function WriteAttributeFloat(string $Name, float $Value)
  {
    return true;
  }
  protected function WriteAttributeString(string $Name, string $Value)
  {
    return true;
  }
  ...
  protected function ConnectParent(string $ModuleID)
  {
    return true;
  }
  protected function RequireParent(string $ModuleID)
  {
    return true;
  }
  protected function ForceParent(string $ModuleID)
  {
    return true;
  }
  ...
  protected function SetBuffer(string $Name, string $Data)
  {
    return true;
  }
  protected function GetBuffer(string $Name)
  {
    return '';
  }
  ...
  protected function SendDebug(string $Message, string $Data, int $Format)
  {
    return true;
  }
  protected function RegisterMessage(int $SenderID, int $Message)
  {
    return true;
  }
  protected function UnregisterMessage(int $SenderID, int $Message)
  {
    return true;
  }
  ...
  protected function GetReferenceList()
  {
    return [];
  }
  protected function UpdateFormField(string $Name, string $Parameter, $Value)
  {
    return true;
  }
  ...
  protected function LogMessage(string $Message, int $Type)
  {
    return true;
  }
  protected function SetReceiveDataFilter(string $RequiredRegexMatch)
  {
    return true;
  }
  ...
  protected function SetForwardDataFilter(string $RequiredRegexMatch)
  {
    return true;
  }
  ...
  public function SetVisualizationType(int $value)
  {
    return true;
  }
  public function UpdateVisualizationValue($data)
  {
    return true;
  }
}
